if (window.innerWidth > 1314) {
  // Vérifie si l'écran est considéré comme desktop
  const script = document.createElement("script");
  script.src = "https://unpkg.com/flubber";
  script.onload = function () {
    // Ce code ne s'exécutera qu'après le chargement complet de Flubber
  ...
  // Mettez ici le code qui doit s'exécuter uniquement sur mobile ou sur des écrans plus petits
}
